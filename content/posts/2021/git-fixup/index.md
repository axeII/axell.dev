...
It happens to all of us. You are working on project. Boss calls you that there is a bug. You try to debug this problem. You fix it and push it to git. After more commits you release that one specific commit contains one very stupid mistake. One line has breakpoint inside the code which now breaks code. _Don't ask why I am so specific_.
...
9cae9d6 2021-01-19 Ales Lerch Commit that contains bug
...
```text
d31e70c 2021-01-19 Ales Lerch (HEAD -> master) fixup! Commit that contains bug
...
0dd4685 2021-01-19 Ales Lerch Commit that contains bug
